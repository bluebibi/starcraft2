...
class TerranAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        if obs.first():
            ...
            print("self.attack_coordinates:", self.attack_coordinates)
    ...
    try:
        while True:
            with sc2_env.SC2Env(
                map_name="Simple64",
                players=[
                    sc2_env.Agent(sc2_env.Race.terran), # 테란 선택. (zerg, protoss, terran, random 선택 가능)
                    sc2_env.Bot(
                        sc2_env.Race.random,
                ...
                step_mul=16,
                # the game speed 설정. 8 -> 300APM, 16 --> 150APM
                # an action is performed after that number of game steps.
